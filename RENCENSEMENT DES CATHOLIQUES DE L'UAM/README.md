...
Petite application web locale (formulaire + base de données SQLite) pour enregistrer les catholiques de l'UAM et afficher la liste après chaque inscription.
...
- La base de données est un fichier local : `data/recensement.sqlite3`
...
- Avec SQLite sur Render, les données peuvent être perdues après redéploiement/restart.
- Pour des données 100% persistantes, il faudra passer à PostgreSQL (je peux te le configurer).
